...
public class IAPKey
{
    public const string PACK1 = "wrench.add1";
    public const string PACK2 = "wrench.add3";
    public const string PACK3 = "wrench.add5";
    public const string PACK4 = "wrench.add10";
    public const string PACK5 = "wrench.add10";
    public const string PACK6 = "wrench.add10";
}
...
public class IAPManager : PersistentSingleton<IAPManager>, IStoreListener
{
    ...
    public void RestorePurchases(System.Action<bool> OnRestored)
    {
            ...
            Application.platform == RuntimePlatform.OSXPlayer)
        {
            ...
            apple.RestoreTransactions((result,data) =>
            {
